...
import SocketServer from "./websocket/websocket.js";
...
server.listen(env.PORT || 8080, (err) => console.log(err || 'Http Server Online'));
new SocketServer(server).enableListeners();